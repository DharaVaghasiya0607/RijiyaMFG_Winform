    ...
    public class BOTRN_RunninPossition
    {
        ...
        public DataSet FullKapanAnalysis(string pStrKapan, string pStrOpe, string pStrFromDate, string pStrToDate, bool pIsWithPCNStock, string pStrGrdType, string pStrMainManager_ID, string pStrPacktCategory, string pStrPacketGroup)
        {
            try
            {
                ...
                Ope.FillDSet(Config.ConnectionString, Config.ProviderName, DS, "Temp", "RP_SingleKapanAnalysis_DV", CommandType.StoredProcedure);
                return DS;
            }
            catch (Exception Ex)
            {
        ...
        public DataSet GetProcessWiseReport(string pStrKapanName,string pStrKapanID, string pStrProcessID, Int64 pIntEmployeeID, string pStrFromDate, string pStrToDate, Int32 pBoolIsIssue, bool pBoolIsNotInProcess, string pStrMainManager_ID, string pStrDepartmentID
            ...
            )
        {
            try
            {
                ...
                Ope.AddParams("KAPAN_ID", pStrKapanID, DbType.String, ParameterDirection.Input);
        ...
        public DataTable GetMarkerRollingReportNew(Int64 pIntEmployee_ID, string pStrReportType = "SUMMARY", string pStrProcessName = "", string pStrKapanName = "", int pIntFromPacketNo = 0, int pIntToPacketNo = 0, string pStrTag = "", string pStrKapanManager = "")
        {
            try
            {
                DataTable DTab = new DataTable();
                ...
                Ope.AddParams("REPORTTYPE", pStrReportType, DbType.String, ParameterDirection.Input);
                Ope.AddParams("PROCESSNAME", pStrProcessName, DbType.String, ParameterDirection.Input);
                Ope.AddParams("KAPANMANAGER_ID", pStrKapanManager, DbType.String, ParameterDirection.Input);
        ...
        public DataTable GetStockPrintReport(string pStrOpe, string pStrKapanName,string pStrKapanID, string pStrTable ,string pStrMarker_ID, string pStrProcessName, string pStrMainManager_ID, string pStrViewType, string pStrPacketCategory, string pStrPacketGroup)
        {
            try
            {
                DataTable DTab = new DataTable();
        ...
        public DataTable GetStockPrintKapanWiseReport(string pStrOpe, string pStrKapanName, string pStrKapanID, string pStrTable, string pStrMarker_ID, string pStrProcessName, string pStrReportGroup, string pPacketCategorty, string pStrPacketGroup)
        {
            try
            {
                DataTable DTab = new DataTable();
                ...
                Ope.AddParams("PACKETGROUP", pStrPacketGroup, DbType.String, ParameterDirection.Input);
                Ope.FillDTab(Config.ConnectionString, Config.ProviderName, DTab, "RP_StockPrintKapanWiseReport_DHARA", CommandType.StoredProcedure);
                return DTab;
            }
            catch (Exception Ex)
            {
        ...
        public DataSet PlanningReportAssorterWiseGetData(string strKapanName, string pStrTablename, string strFromDate, string strToDate, string pStrPrdType_ID, string pStrMainManager_ID, string pStrViewType, string pStrAssorter_ID, string pStrPacketCatogery, string pStrPacketGroup,string pStrOpe,string pStrDiamondType)
        {
            try
            {
                DataSet DTab = new DataSet();
        ...
        public DataSet ComboReportGetData(string pStrKapan)
        {
            try
            {
                DataSet DS = new DataSet();
                ...
                Ope.FillDSet(Config.ConnectionString, Config.ProviderName, DS, "Temp", "RPT_FullKapanAssortmentReport", CommandType.StoredProcedure);
                return DS;
            }
            catch (Exception Ex)
            {
        ...
        public DataTable PurityWiseGetData(string pStrKapan)
        {
            try
            {
                DataTable DTab = new DataTable();
                ...
                Ope.FillDTab(Config.ConnectionString, Config.ProviderName, DTab, "RPT_PurityAssortment", CommandType.StoredProcedure);
                return DTab;
            }
            catch (Exception Ex)
            {
        ...
        public DataTable SizeWiseGetData(string pStrKapan)
        {
            try
            {
                DataTable DTab = new DataTable();
                ...
                Ope.FillDTab(Config.ConnectionString, Config.ProviderName, DTab, "RPT_SizeAssortment", CommandType.StoredProcedure);
                return DTab;
            }
            catch (Exception Ex)
            {
        ...
        public DataTable ShapeWiseGetData(string pStrKapan)
        {
            try
            {
                ...
                Ope.FillDTab(Config.ConnectionString, Config.ProviderName, DS, "RPT_ShapeAssortment", CommandType.StoredProcedure);
                return DS;
            }
            catch (Exception Ex)
            {
        ...
        public DataSet RunningPosstionDataPacketDetailWise(string mStrFromType, string pStrPktStockCategory, string pStrPktStockType,string pStrPktStrKapan,Int32 pIntPktNo, string pStrPktTag,bool pBoolPktExtraStock, string pStrPktProcess, string pIntPktManager_ID, string pStrPktSubProcess, string pStrOPE, string PStrPktDepartmentName, string pStrPktManagerName, string pStrEmployeeName,string pStrProcessName, string pStrMainManager, string pStrPktStock)
        {
            try
            {
                ...
                Ope.AddParams("STOCKTYPE", pStrPktStockType, DbType.String, ParameterDirection.Input);
                Ope.AddParams("STOCK", pStrPktStock, DbType.String, ParameterDirection.Input);
                Ope.AddParams("REPORTTYPE", pStrOPE, DbType.String, ParameterDirection.Input);
                Ope.AddParams("FORMTYPE", mStrFromType, DbType.String, ParameterDirection.Input);
                Ope.AddParams("STOCKCATEGORY", pStrPktStockCategory, DbType.String, ParameterDirection.Input);
                Ope.AddParams("KAPANNAME", pStrPktStrKapan, DbType.String, ParameterDirection.Input);
                Ope.AddParams("PACKETNO", pIntPktNo, DbType.Int32, ParameterDirection.Input);
                Ope.AddParams("TAG", pStrPktTag, DbType.String, ParameterDirection.Input);
                Ope.AddParams("COMPANY_ID", Config.gEmployeeProperty.COMPANY_ID, DbType.Int64, ParameterDirection.Input);
                Ope.AddParams("EMPLOYEE_ID", Config.gEmployeeProperty.LEDGER_ID, DbType.Int64, ParameterDirection.Input);
                Ope.AddParams("DEPARTMENT_ID", Config.gEmployeeProperty.DEPARTMENT_ID, DbType.Int64, ParameterDirection.Input);
                Ope.AddParams("PROCESS_ID", pStrPktProcess, DbType.String, ParameterDirection.Input);
                Ope.AddParams("SUBGROUP", pStrPktSubProcess, DbType.String, ParameterDirection.Input);
                Ope.AddParams("MAINMANAGER_ID", pIntPktManager_ID, DbType.String, ParameterDirection.Input);
                Ope.AddParams("DEPARTMENTNAME", PStrPktDepartmentName, DbType.String, ParameterDirection.Input);
                Ope.AddParams("MANAGERNAME", pStrPktManagerName, DbType.String, ParameterDirection.Input);
                Ope.AddParams("EMPLOYEENAME", pStrEmployeeName, DbType.String, ParameterDirection.Input);
                Ope.AddParams("PROCESSNAME", pStrProcessName, DbType.String, ParameterDirection.Input);
                Ope.AddParams("MAINMANAGER", pStrMainManager, DbType.String, ParameterDirection.Input);

                Ope.FillDSet(Config.ConnectionString, Config.ProviderName, DS, "TEMP", "RP_SingleRunningPossitionPacketWiseSummary", CommandType.StoredProcedure);
                return DS;
            }
            catch (Exception Ex)
            {
