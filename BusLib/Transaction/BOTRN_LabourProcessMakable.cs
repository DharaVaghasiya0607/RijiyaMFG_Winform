...
{
  public  class BOTRN_LabourProcessMakable
    {
        ...
        public DataTable Fill(TrnLabourProcessProperty pClsProperty)
        {
            ...
            //Ope.AddParams("PLANNIGGRADE_ID", pClsProperty.PACKETGRADE_ID, DbType.String, ParameterDirection.Input);            
            Ope.AddParams("PLANGRADE_ID", pClsProperty.PACKETGRADE_ID, DbType.String, ParameterDirection.Input);
            Ope.FillDTab(Config.ConnectionString, Config.ProviderName, DTab, "Trn_LabourProcessMakableGetData", CommandType.StoredProcedure);
            return DTab;
        }

        public DataTable FillPlannigGrade(TrnLabourProcessProperty pClsProperty)
        {
            Ope.ClearParams();
            DataTable DTab = new DataTable();
            ...
            Ope.AddParams("SUBPROCESS_ID", pClsProperty.SUBPROCESS_ID, DbType.Int32, ParameterDirection.Input);
            Ope.AddParams("LABOURTYPE", pClsProperty.LABOURTYPE, DbType.String, ParameterDirection.Input);
            Ope.AddParams("PLANNINGGRADE_ID", pClsProperty.PLANNINGGRADE_ID, DbType.String, ParameterDirection.Input);
            Ope.AddParams("ROUGHTYPE", pClsProperty.ROUGHTYPE, DbType.String, ParameterDirection.Input);
            Ope.FillDTab(Config.ConnectionString, Config.ProviderName, DTab, "Trn_LabourProcessMakablePlannigGetData", CommandType.StoredProcedure);
            return DTab;
        }

        public DataTable GetPlanningGrade(string pStrRoughType)
        {
            Ope.ClearParams();
            DataTable DTab = new DataTable();
            Ope.AddParams("ROUGHTYPE", pStrRoughType, DbType.String, ParameterDirection.Input);
            Ope.FillDTab(Config.ConnectionString, Config.ProviderName, DTab, "Trn_PlannigGradeGetData", CommandType.StoredProcedure);
            return DTab;
        }

        public TrnLabourProcessProperty SaveForMkable(TrnLabourProcessProperty pClsProperty)
        {
            try
            {
                Ope.ClearParams();
                ...
                Ope.AddParams("MANAGER_ID", pClsProperty.MANAGER_ID, DbType.Int64, ParameterDirection.Input);
                Ope.AddParams("PACKETGRADE_ID", pClsProperty.PACKETGRADE_ID, DbType.Int32, ParameterDirection.Input);
                Ope.AddParams("PACKETGRADENAME", pClsProperty.PACKETGRADENAME, DbType.String, ParameterDirection.Input);
                Ope.AddParams("LABOURTYPE", pClsProperty.LABOURTYPE, DbType.String, ParameterDirection.Input);
                ...
                ArrayList AL = Ope.ExeNonQueryWithOutParameter(Config.ConnectionString, Config.ProviderName, "Trn_LabourProcessMakableSave", CommandType.StoredProcedure);
        ...
        public TrnLabourProcessProperty SaveForMkablePlaning(TrnLabourProcessProperty pClsProperty)
        {
            try
            {
                Ope.ClearParams();
                ...
                ArrayList AL = Ope.ExeNonQueryWithOutParameter(Config.ConnectionString, Config.ProviderName, "Trn_LabourProcessMakablePlannigSave", CommandType.StoredProcedure);
        ...
        public TrnLabourProcessProperty Delete(TrnLabourProcessProperty pClsProperty)
        {
            try
            {
                ...
                ArrayList AL = Ope.ExeNonQueryWithOutParameter(Config.ConnectionString, Config.ProviderName, "Trn_LabourProcessMakableDelete", CommandType.StoredProcedure);
        ...
        public int CopyPasteLabourProcessData(int pIntFromYear, int pIntFromMonth, int pIntToYear, string pStrToMonth, int pIntFromProcess_ID, int pIntToProcess_ID, int pIntFromDept_ID, int pIntToDept_ID, Int64 pIntFromManager_ID, Int64 pIntToManager_ID, string pXmlYearMonth, int SubProcess_Id)//int COPYTOYYYY,
        {
            try
            {
                Ope.ClearParams();
        ...
        public int CopyPasteLabourProcessDataForMakable(int pIntFromYear, int pIntFromMonth, int pIntToYear, string pStrToMonth, int pIntFromProcess_ID, int pIntToProcess_ID, int pIntFromDept_ID, int pIntToDept_ID, Int64 pIntFromManager_ID, Int64 pIntToManager_ID, string pXmlYearMonth, int SubProcess_Id, int pIntPacketGrade_ID, string pStrCopyToLabour)//int COPYTOYYYY,
        {
            try
            {
                ...
                Ope.AddParams("PACKETGRADE_ID", pIntPacketGrade_ID, DbType.Int32, ParameterDirection.Input);

                //Ope.AddParams("COPYTOYYYY", COPYTOYYYY, DbType.Int32, ParameterDirection.Input);//urvisha add by:05-04-2023
                Ope.AddParams("XMLYEARMONTH", pXmlYearMonth, DbType.Xml, ParameterDirection.Input);//urvisha add by:05-04-2023

                Ope.AddParams("SUBPROCESS_ID", SubProcess_Id, DbType.Int32, ParameterDirection.Input);//Gunjan:26/06/2023
                Ope.AddParams("LABOURTYPE", pStrCopyToLabour, DbType.Int32, ParameterDirection.Input);//Gunjan:26/06/2023

                Ope.AddParams("ENTRYBY", Configuration.BOConfiguration.gEmployeeProperty.LEDGER_ID, DbType.Int64, ParameterDirection.Input);
                Ope.AddParams("ENTRYIP", Configuration.BOConfiguration.ComputerIP, DbType.String, ParameterDirection.Input);

                return Ope.ExeNonQuery(Config.ConnectionString, Config.ProviderName, "TRN_LabourProcessMakableCopyPaste", CommandType.StoredProcedure);
        ...
        public TrnLabourProcessProperty SaveForMkablePlanning(TrnLabourProcessProperty pClsProperty)
        {
            try
            {
                Ope.ClearParams();
                ...
                ArrayList AL = Ope.ExeNonQueryWithOutParameter(Config.ConnectionString, Config.ProviderName, "Trn_LabourProcessMakablePlanningSave", CommandType.StoredProcedure);
