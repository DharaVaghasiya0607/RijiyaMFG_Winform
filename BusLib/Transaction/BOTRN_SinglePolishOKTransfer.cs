    ...
    public class BOTRN_SinglePolishOKTransfer
    {
        ...
        public PolishIssueReturnProperty SaveAndUpdate(string StrXML, string StrXMLSelection, PolishIssueReturnProperty pClsProperty)
        {
            try
            {
                ...
                Ope.AddParams("JANGEDNORET", pClsProperty.JANGEDNO, DbType.Int64, ParameterDirection.Input);
                ...
                if (AL.Count != 0)
                {
                    ...
                    pClsProperty.JANGEDNO = Val.ToInt64(AL[3]);
                }
            }
        ...
        public DataTable PolishOKTransferPrint(Int64 pIntJangedNo)
        {
            DataTable DTab = new DataTable();
            Ope.ClearParams();
