...
namespace BusLib.Master
{
    public class BOTRN_KapanInward
    {
        ...
        public DataTable FillSummary(string pStrInwardNo, string pStrKapan, string pStrFromData, string pStrToDate, string pStrStatus, string pStrDiamondType, String ptrYear_ID)
        {
            Ope.ClearParams();
            DataTable DTab = new DataTable();
            ...
            Ope.AddParams("YEAR_ID", ptrYear_ID, DbType.String, ParameterDirection.Input);
        ...
        public DataSet FillSummaryForOutward(string pStrInwardNo, string pStrKapan, string pStrFromInwardData, string pStrToInwardDate,
            string pStrFromOutwardData, string pStrToOutwardDate,
            string pStrStatus, string pStrDiamondType, string pStrYear_ID, Boolean pBoolIsOutward)
        {
            Ope.ClearParams();
            DataSet DS = new DataSet();
            Ope.AddParams("OPE", "SUMMARY", DbType.String, ParameterDirection.Input);
            Ope.AddParams("INWARDNO", pStrInwardNo, DbType.Int64, ParameterDirection.Input);
            Ope.AddParams("FROMINWARDDATE", pStrFromInwardData, DbType.Date, ParameterDirection.Input);
            Ope.AddParams("TOINWARDDATE", pStrToInwardDate, DbType.Date, ParameterDirection.Input);
            Ope.AddParams("FROMOUTWARDDATE", pStrFromOutwardData, DbType.Date, ParameterDirection.Input);
            Ope.AddParams("TOOUTWARDDATE", pStrToOutwardDate, DbType.Date, ParameterDirection.Input);
            Ope.AddParams("STATUS", pStrStatus, DbType.String, ParameterDirection.Input);
            Ope.AddParams("KAPANNAME", pStrKapan, DbType.String, ParameterDirection.Input);
            Ope.AddParams("DIAMONDTYPE", pStrDiamondType, DbType.String, ParameterDirection.Input);
            Ope.AddParams("YEAR_ID", pStrYear_ID, DbType.String, ParameterDirection.Input);
            Ope.AddParams("ISOUTWARD", pBoolIsOutward, DbType.Boolean, ParameterDirection.Input);
        ...
        public DataTable SizeAssortmentGetKapanData(string pStrInwardNo, string pStrKapan, string pStrFromData, string pStrToDate, string pStrStatus, string pStrDiamondType, string pStrYear_ID)
        {
            Ope.ClearParams();
            DataTable DTab = new DataTable();
            ...
            Ope.AddParams("TODATE", pStrToDate, DbType.Date, ParameterDirection.Input);
            Ope.AddParams("STATUS", pStrStatus, DbType.String, ParameterDirection.Input);
            Ope.AddParams("DIAMONDTYPE", pStrDiamondType, DbType.String, ParameterDirection.Input);//Add by urvisha :09-05-2024
            Ope.AddParams("KAPANNAME", pStrKapan, DbType.String, ParameterDirection.Input);
        ...
        public DataTable SizeAssortmentGetSizeData(string pStrKapanName , int pIntShapeID, bool IsAdditionalAssortment, string pStrRoughType)
        {
            Ope.ClearParams();
            DataTable DTab = new DataTable();
            Ope.AddParams("OPE", "DETAIL", DbType.String, ParameterDirection.Input);
            ...
            Ope.AddParams("YEAR_ID", Config.FINYEAR_ID, DbType.Int32, ParameterDirection.Input);
            Ope.AddParams("DIAMONDTYPE", pStrRoughType, DbType.String, ParameterDirection.Input);

             Ope.FillDTab(Config.ConnectionString, Config.ProviderName, DTab, "Parcel_SizeAssortmentGetData", CommandType.StoredProcedure);
            return DTab;
        }

        public DataTable ClarityAssortmentGetKapanData(string pStrKapan, string pStrFromData, string pStrToDate, string pStrStatus, string pStrDiamondType, string pStrMixSizeID, Guid pGuidUser_ID, String pStrYear_ID)
        {
            Ope.ClearParams();
            DataTable DTab = new DataTable();
        ...
        public DataTable ClarityAssortmentGetSizeData(string pKapanName, Guid pStrSizeAssortID, int pIntDepartmentID, string pStrMixSize_ID, Int32 pStrShape_ID, String pStrYear_ID)
        {
            Ope.ClearParams();
            DataTable DTab = new DataTable();
            Ope.AddParams("OPE", "DETAIL", DbType.String, ParameterDirection.Input);
        ...
        public DataSet GetClarityAssortmentData(string pStrKapan, string pIntPriceDate, string pStrPriceType)
        {
            Ope.ClearParams();
            DataSet DS = new DataSet();
            ...
            Ope.AddParams("DIAMONDTYPE", pStrPriceType, DbType.Date, ParameterDirection.Input);//Gunjan:19/04/2023
