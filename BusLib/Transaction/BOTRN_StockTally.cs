...
namespace BusLib.Transaction
{
    public class BOTRN_StockTally
    {
        ...
        public TrnStockTallyProperty SaveWithXml(TrnStockTallyProperty pClsProperty, string pStrDate, int pIntDepartment, Int64 pIntEmployee, bool pIsWithExtraStock, Int64 pIntManager,
             string pStrFound,
            int pIntScanDepartmentID
            )
        {
            try
            {
                ...
                Ope.AddParams("XMLFOUND", pStrFound, DbType.Xml, ParameterDirection.Input);
                Ope.AddParams("SCANDEPARTMENT_ID", pIntScanDepartmentID, DbType.Int32, ParameterDirection.Input);
                ...
                ArrayList AL = Ope.ExeNonQueryWithOutParameter(Config.ConnectionString, Config.ProviderName, "Trn_StockTalllyXmlSave", CommandType.StoredProcedure);
        ...
        public DataSet GetDataWithXML(string pStrDate, int pIntDepartment, Int64 pIntEmployee, bool pIsWithExtraStock, Int64 pIntManager,
             string pStrFound,
            int pIntScanDepartmentID
            )
        {
        ...
        public DataSet GetDataFinalAndSave(string pStrDate, int pIntDepartment, Int64 pIntEmployee, bool pIsWithExtraStock, Int64 pIntManager,
            string pStrFound,
            int pIntScanDepartmentID
            )
        {
            ...
            Ope.FillDSet(Config.ConnectionString, Config.ProviderName, DS, "Temp", "Trn_StockTalllyGetDataFinal", CommandType.StoredProcedure);
