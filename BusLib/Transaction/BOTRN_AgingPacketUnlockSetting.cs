...
{
    public class BOTRN_AgingPacketUnlockSetting
    {
        ...
        public DataTable Fill(string pStrFromDate,string pStrToDate,string pStrKapan)
        {
            ...
            Ope.FillDTab(Config.ConnectionString, Config.ProviderName, DTab, "Trn_AgingPacketUnlockEntryGetData", CommandType.StoredProcedure);
            return DTab;
        }
        public DataRow GetScanPacketDetail(string pStrKapan, int pIntPacketNo, string pStrTag)
        {
            ...
            return Ope.GetDataRow(Config.ConnectionString, Config.ProviderName, "Trn_AgingPacketUnlockEntryGetData", CommandType.StoredProcedure);
        }

        public TrnAgingPacketUnlockSettingProperty Save(TrnAgingPacketUnlockSettingProperty pClsProperty)
        {
            try
            {
                Ope.ClearParams();
                ...
                Ope.AddParams("UNLOCKTYPE", pClsProperty.UNLOCKTYPE, DbType.String, ParameterDirection.Input);
                ...
                ArrayList AL = Ope.ExeNonQueryWithOutParameter(Config.ConnectionString, Config.ProviderName, "Trn_AGINGPacketUnlockEntrySave", CommandType.StoredProcedure);
        ...
        public TrnPacketUnlockSettingProperty Delete(TrnPacketUnlockSettingProperty pClsProperty)
        {
            try
            {
                ...
                ArrayList AL = Ope.ExeNonQueryWithOutParameter(Config.ConnectionString, Config.ProviderName, "Trn_AgingPacketUnlockEntryDelete", CommandType.StoredProcedure);
