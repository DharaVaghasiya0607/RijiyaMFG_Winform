    ...
    public class BOMST_Report
    {
        ...
        public DataSet GenerateMaintainanceReport(MST_ReportProperty pClsProperty)
        {
            ...
            try
            {
                ...
                Ope.AddParams("TABLENAME", pClsProperty.TABLENAME, DbType.String); // Dhara : 15-09-2023
                ...
                Ope.AddParams("SHIFTTYPE", pClsProperty.SHIFTTYPE, DbType.String);

                Ope.AddParams("FromPacketNo", pClsProperty.FromPacketNo, DbType.String);
                Ope.AddParams("ToPacketNo", pClsProperty.ToPacketNo, DbType.String);

                Ope.AddParams("PACKETCATEGORY", pClsProperty.PacketCategory, DbType.String);
                Ope.AddParams("PACKETGROUP", pClsProperty.PacketGroup, DbType.String);

                Ope.AddParams("KapanStatus", pClsProperty.KapanStatus, DbType.String);
                Ope.AddParams("KapanCreateFromDate", pClsProperty.KapanCreateFromDate, DbType.String);
                Ope.AddParams("KapanCreateToDate", pClsProperty.KapanCreateToDate, DbType.String);
                Ope.AddParams("ClvIssueFromDate", pClsProperty.ClvIssueFromDate, DbType.String);
                Ope.AddParams("ClvIssueToDate", pClsProperty.ClvIssueToDate, DbType.String);
                Ope.AddParams("ClvCompleteFromDate", pClsProperty.ClvCompleteFromDate, DbType.String);
                Ope.AddParams("ClvCompleteToDate", pClsProperty.ClvCompleteToDate, DbType.String);
                Ope.AddParams("MFGIssueFromDate", pClsProperty.MFGIssueFromDate, DbType.String);
                Ope.AddParams("MFGIssueToDate", pClsProperty.MFGIssueToDate, DbType.String);
                Ope.AddParams("MFGCompleteFromDate", pClsProperty.MFGCompleteFromDate, DbType.String);
                Ope.AddParams("MFGCompleteToDate", pClsProperty.MFGCompleteToDate, DbType.String);
                Ope.AddParams("PolishReceiveFromDate", pClsProperty.PolishReceiveFromDate, DbType.String);
                Ope.AddParams("PolishReceiveToDate", pClsProperty.PolishReceiveToDate, DbType.String);
                Ope.AddParams("MumbaiReceiveFromDate", pClsProperty.MumbaiReceiveFromDate, DbType.String);
                Ope.AddParams("MumbaiReceiveToDate", pClsProperty.MumbaiReceiveToDate, DbType.String);
                Ope.AddParams("DIAMONDTYPE", pClsProperty.DIAMONDTYPE, DbType.String);
