...
namespace AxoneMFGRJ.bin.Debug.RPT {
    using System;
    ...
    public class KapanEstimate : ReportClass {
        
        public KapanEstimate() {
        }
        
        public override string ResourceName {
            get {
                return "KapanEstimate.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "AxoneMFGRJ.bin.Debug.RPT.KapanEstimate.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedKapanEstimate : Component, ICachedReport {
        
        public CachedKapanEstimate() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            KapanEstimate rpt = new KapanEstimate();
            rpt.Site = this.Site;
            return rpt;
        }
