...
{
    public partial class FrmMarkerVariationReport : Form
    {
        ...
        public FrmMarkerVariationReport()
        {
            InitializeComponent();
        }
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                DTabDetail = Obj.GetVariationReportGetData(mStrFromDate, mStrToDate, Val.ToInt64(txtEmployee.Tag));
        ...
        private void BtnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                svDialog.DefaultExt = ".xlsx";
                svDialog.Title = "Export to Excel";
                svDialog.FileName = "Marker Variation Report";
                svDialog.Filter = "Excel files 97-2003 (*.xls)|*.xls|Excel files 2007(*.xlsx)|*.xlsx|All files (*.*)|*.*";
                if ((svDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK))
                {
                    PrintableComponentLinkBase link = new PrintableComponentLinkBase()
                    ...
                    if (Global.Confirm("Do You Want To Open [Variation.xlsx] ?") == System.Windows.Forms.DialogResult.Yes)
                    {
                        System.Diagnostics.Process.Start(svDialog.FileName, "CMD");
                    }
                }
