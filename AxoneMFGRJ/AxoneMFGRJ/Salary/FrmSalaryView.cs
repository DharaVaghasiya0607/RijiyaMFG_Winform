...
namespace AxoneMFGRJ.Salary
{
    public partial class FrmSalaryView : Form
    {
        ...
        double DouTotalSuratExpAmount = 0;
        double DouBeforeSuratExp_MinusDollar = 0;
        ...
        private void BtnRefresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                mStrSalaryType = Val.ToString(CmbSalaryType.SelectedItem);
                ...
                mISWithRejectedEmp = Val.ToBoolean(ChkISWithRejectedEmp.Checked);
                ...
                DataSet DS = Obj.GetSalaryViewSummaryDetail(Val.Trim(CmbKapan.Properties.GetCheckedItems()), Val.ToInt32(txtFromPacketNo.Text), Val.ToInt32(txtToPacketNo.Text), StrSalaryType, Val.ToInt64(txtEmployee.Tag), Val.SqlDate(DTPFromDate.Value.ToShortDateString()), Val.SqlDate(DTPToDate.Value.ToShortDateString()), "OFFICESALARY", Val.ToBoolean(ChkISWithRejectedEmp.Checked));
        ...
        {
            string MergeOnStr = "DFTYPE,PLANVARIATIONDOLLAR,PLANVARIATIONRUPEES,PLANVARIATIONPER,DFPLUSDOLLAR,DFMINUSDOLLAR,DFPLUSPER,DFMINUSPER,DFPLUSRUPEES,DFMINUSRUPEES,BEFORESURTEXP_MINUSDOLLAR";
            ...
            MergeOnStr = MergeOnStr + ",TOTALORGAMOUNT,BEFOREPER_CHECKEROKMINUSDOLLAR,CHECKEROKMINUSPER,CHECKEROKMINUSDOLLAR,CHECKEROKMINUSRUPEES,TOTALAMOUNTTALLY,TOTALSURATEXPAMOUNT,TOTALMFGMINUSDOLLAR,TOTALBLKMINUSDOLLAR,BTNDATAPROCESS,BTNPROCESSPRDDETAIL"; //FINAL_LABOURPER,FINAL_LABOURAMOUNTDOLLAR,FINAL_LABOURAMOUNTRUPEES";
        ...
        private void GrdDetail_RowClick(object sender, RowClickEventArgs e)
        {
            try
            {
                ...
                else if (GrdDetail.FocusedColumn.FieldName == "BTNDATAPROCESS")
                {
                    ...
                    string StrPacketTag = StrKapan + "-" + Val.ToString(IntPacketNo);
                    ...
                    IntRes = Obj.ResetMarkerWorkerPacketDataForProcess(StrKapan, IntPacketNo, IntPacketNo,"", Val.SqlDate(DTPFromDate.Value.ToShortDateString()), Val.SqlDate(DTPToDate.Value.ToShortDateString()), "MARKER"); //PolishOk Process
                    IntRes = Obj.UpdateMarkerDataProcessWithOnlyPktDetail(StrKapan, IntPacketNo, IntPacketNo);
                ...
                else if (GrdDetail.FocusedColumn.FieldName == "BTNPROCESSPRDDETAIL")
                {
                    DataRow Dr = GrdDetail.GetFocusedDataRow();
                    ...
                    FrmPrdViewForProcessPktDetailSimple.ShowForm(StrKapan, IntPacketNo, StrTag, "CLV");
                    this.Cursor = Cursors.Default;
                }
                else if (e.Clicks == 2 && e.RowHandle >= 0 && (GrdDetail.FocusedColumn.FieldName != "BTNDATAPROCESS") && (GrdDetail.FocusedColumn.FieldName != "BTNPROCESSPRDDETAIL"))
                {
                    DataRow DR = GrdDetail.GetDataRow(e.RowHandle);
                    string StrKapan = Val.ToString(DR["KAPANNAME"]);
                    int IntPacketNO = Val.ToInt(DR["PACKETNO"]);
        ...
        private void GrdDetail_CustomSummaryCalculate(object sender, DevExpress.Data.CustomSummaryEventArgs e)
        {
            try
            {
                if (e.SummaryProcess == CustomSummaryProcess.Start)
                {
                    ...
                    DouTotalSuratExpAmount = 0;
                    DouBeforeSuratExp_MinusDollar = 0;
                ...
                else if (e.SummaryProcess == CustomSummaryProcess.Calculate)
                {
                    ...
                    if (P1 != P2)
                    {
                        ...
                        DouTotalAmount = DouTotalAmount + Val.Val(GrdDetail.GetRowCellValue(e.RowHandle, "TOTALAMOUNT"));
                        ...
                        DouTotalSuratExpAmount = DouTotalSuratExpAmount + Val.Val(GrdDetail.GetRowCellValue(e.RowHandle, "TOTALSURATEXPAMOUNT"));
                        DouBeforeSuratExp_MinusDollar = DouBeforeSuratExp_MinusDollar + Val.Val(GrdDetail.GetRowCellValue(e.RowHandle, "BEFORESURTEXP_MINUSDOLLAR"));
                        //End : #P : 06-02-2020
                    }
                ...
                else if (e.SummaryProcess == CustomSummaryProcess.Finalize)
                {
                    ...
                    if (((DevExpress.XtraGrid.GridSummaryItem)e.Item).FieldName.CompareTo("TOTALAMOUNT") == 0)
                    {
                        e.TotalValue = Val.Format(DouTotalAmount, "###0.00");
                    }
                    ...
                    if (((DevExpress.XtraGrid.GridSummaryItem)e.Item).FieldName.CompareTo("TOTALSURATEXPAMOUNT") == 0)
                    {
                        e.TotalValue = Val.Format(DouTotalSuratExpAmount, "###0.00");
                    }
                    if (((DevExpress.XtraGrid.GridSummaryItem)e.Item).FieldName.CompareTo("BEFORESURTEXP_MINUSDOLLAR") == 0)
                    {
                        e.TotalValue = Val.Format(DouBeforeSuratExp_MinusDollar, "###0.00");
                    }
                }
            }
            catch (Exception ex)
        ...
        private void MainGridSummary_Click(object sender, EventArgs e)
        {
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                //DSDetail = Obj.GetSalaryViewSummaryDetail(Val.Trim(CmbKapan.Properties.GetCheckedItems()), Val.ToInt32(txtFromPacketNo.Text), Val.ToInt32(txtToPacketNo.Text), Val.ToString(CmbSalaryType.SelectedItem), Val.ToInt64(txtEmployee.Tag), Val.SqlDate(DTPFromDate.Value.ToShortDateString()), Val.SqlDate(DTPToDate.Value.ToShortDateString()), "OFFICESALARY", Val.ToBoolean(ChkISWithRejectedEmp.Checked));
                DSDetail = Obj.GetSalaryViewSummaryDetail(mStrKapanName, mIntFromPacketNo, mIntToPacketNo, mStrSalaryType, mIntEmployee_ID, Val.SqlDate(mStrFromDate), Val.SqlDate(mStrToDate), "OFFICESALARY", mISWithRejectedEmp);
                ...
                if (DSDetail.Tables.Count > 1)
                {
                    ...
                    DTabPlanVariationDetail = DSDetail.Tables[3];
                    DTabDFPlusMinus = DSDetail.Tables[4];
                }
            }
            catch (Exception ex)
            {
        ...
        private void backgroundWorker1_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                ...
                GrdSummary.BestFitColumns();
                GrdDetYearMonth.BestFitColumns();
        ...
        private void repISNoDollarVariation_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                if (GrdDetail.FocusedRowHandle < 0)
                ...
                GrdDetail.SetRowCellValue(GrdDetail.FocusedRowHandle, "ISNOTCONSIDERDOLLARMINUSVARIATION", IntISNotConsiderDollarMinus);

                for (int IntI = 0; IntI < GrdDetail.RowCount; IntI++)
                {
                    DataRow DD = GrdDetail.GetDataRow(IntI);

                    //string Str = Val.ToString(DD["KAPANPACKET"]);

                    //if (DD != null && Val.ToString(DD["KAPANPACKET"]) == Val.ToString(DRow["KAPANPACKET"]))
                    //{
                    //    GrdDetail.SetRowCellValue(IntI, "ISNOTCONSIDERDOLLARMINUSVARIATION", IntISNotConsiderDollarMinus);
                    //}

                    string Str = Val.ToString(DD["PACKETTAG"]);

                    if (DD != null && Val.ToString(DD["PACKETTAG"]) == Val.ToString(DRow["PACKETTAG"]))
                    {
                        GrdDetail.SetRowCellValue(IntI, "ISNOTCONSIDERDOLLARMINUSVARIATION", IntISNotConsiderDollarMinus);
                    }
                }

                int IntRes = Obj.SaveWagesParameterData("NOTCONSIDERDOLLARMINUSVARIATION", Val.ToString(DRow["KAPANNAME"]),
                                                        Val.ToInt32(DRow["PACKETNO"]), "", //Val.ToString(DRow["TAG"]) //Tag Remove Coz Office Salary ma Pcs wise 6e..
                                                        Val.ToInt64(DRow["WORKER_ID"]),
                                                        false, //ISCONSIDERPLUSDOLLARVARIATION
                                                        false, //ISPROCESSPKTWITHFMKBLCLARITY"]
                                                        false, //Val.ToBoolean(Dr["ISCONSIDERSURATEXPAMTCALC"]), 
        ...
        private void txtPass_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    GrdDetail.Columns["ISNOTCONSIDERDOLLARMINUSVARIATION"].Visible = true;
                ...
                {
                    GrdDetail.Columns["ISNOTCONSIDERDOLLARMINUSVARIATION"].Visible = false;
