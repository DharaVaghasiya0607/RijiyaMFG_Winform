...
{
    public partial class FrmSalaryViewForWorker : Form
    {
        ...
        string mStrFromDate = "";
        string mStrToDate = "";
        bool mISWithRejectedEmp = false;
        string mStrShapeType = "";

        public delegate void SetControlValueCallback(Control oControl, string propName, object propValue);

        string mStrReportTitle = "";

        public FrmSalaryViewForWorker()
        {
            InitializeComponent();
        }
        ...
        public void ShowForm()
        {
            ...
            if (MainGridDetail.RepositoryItems.Count == 4)//Gunjan:30/03/2023
            {
            ...
            GrdDetail.Columns["COLSELECTCHECKBOX"].OwnerBand = GrdDetail.Bands["BANDGENERAL"];
        ...
        private void BtnRefresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //MainGrdManagerSum.DataSource = DTabSummaryManagerWise;
                //GrdManagerSum.RefreshData();
        ...
        private void GrdDet_RowCellStyle(object sender, RowCellStyleEventArgs e)
        {
            ...
            int IsMinusLossCaratInIssueCarat = Val.ToInt(GrdDetail.GetRowCellValue(e.RowHandle, "ISMINUSLOSSCARATINISSUECARAT"));
            ...
            if (xtraTabControl1.SelectedTabPageIndex == 0)
            {
                ...
                try
                {
                    ...
                    if ((svDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK))
                    {
                        ...
                        if (Global.Confirm("Do You Want To Open [WorkerLabourSummary.xlsx] ?") == System.Windows.Forms.DialogResult.Yes)
                        {
                            System.Diagnostics.Process.Start(svDialog.FileName, "CMD");
                        }
                    }
            ...
            else
            {
                ...
                try
                {
                    ...
                    if ((svDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK))
                    {
                        ...
                        if (Global.Confirm("Do You Want To Open [WorkerLabourDetail.xlsx] ?") == System.Windows.Forms.DialogResult.Yes)
                        {
                            System.Diagnostics.Process.Start(svDialog.FileName, "CMD");
                        }
                    }
        ...
        private void GrdSummary_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            ...
            //GrdDetYearMonth.FocusedRowHandle = 0;
            //GrdDetYearMonth.FocusedColumn = GrdDetYearMonth.VisibleColumns[0];
            //GrdDetYearMonth.Focus();
        }
        ...
        private void repChkISConsiderPlusDVariation_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                int IntRes = Obj.SaveWagesParameterData("PLUSDVARIATION", Val.ToString(Dr["KAPANNAME"]), Val.ToInt32(Dr["PACKETNO"]), Val.ToString(Dr["TAG"]), Val.ToInt64(Dr["WORKER_ID"]), Val.ToBoolean(Dr["ISCONSIDERPLUSDOLLARVARIATION"]), Val.ToBoolean(Dr["ISPROCESSPKTWITHFMKBLCLARITY"]), Val.ToBoolean(Dr["ISCONSIDERSURATEXPAMTCALC"]), false, "MFG");
        ...
        private void txtPass_TextChanged(object sender, EventArgs e)
        {
            if (txtPass.Text != "" && txtPass.Tag.ToString().ToUpper() == txtPass.Text.ToString().ToUpper())
            {
                ...
                GrdDetail.Columns["YYMMM"].Visible = true;
                GrdDetail.Columns["RAPAPORT"].Visible = true;
                GrdDetail.Columns["PRICEPERCARAT"].Visible = true;
                GrdDetail.Columns["DISCOUNT"].Visible = true;
                GrdDetail.Columns["GRDCARAT"].Visible = true;
                GrdDetail.Columns["GRDSHAPENAME"].Visible = true;
                GrdDetail.Columns["GRDCOLORNAME"].Visible = true;
                GrdDetail.Columns["GRDCLARITYNAME"].Visible = true;
                GrdDetail.Columns["GRDCUTNAME"].Visible = true;
                GrdDetail.Columns["GRDPOLNAME"].Visible = true;
                GrdDetail.Columns["GRDSYMNAME"].Visible = true;
                GrdDetail.Columns["GRDFLNAME"].Visible = true;
                GrdDetail.Columns["GRDRAPAPORT"].Visible = true;
                GrdDetail.Columns["GRDDISCOUNT"].Visible = true;
                GrdDetail.Columns["GRDPRICEPERCARAT"].Visible = true;
                GrdDetail.Columns["GRDRAPDATE"].Visible = true;
                GrdDetail.Columns["ORGRAPAPORT"].Visible = true;
                GrdDetail.Columns["ORGDISCOUNT"].Visible = true;
                GrdDetail.Columns["ORGPRICEPERCARAT"].Visible = true;
                GrdDetail.Columns["LABOURRATE"].Visible = true;
                GrdDetail.Columns["BONUSPER"].Visible = true;
                GrdDetail.Columns["BONUSLABOURRATE"].Visible = true;

            }
            else
            {
                BtnUpdate.Visible = false;
                GrdDetail.Columns["YYMMM"].Visible = false;
                GrdDetail.Columns["RAPAPORT"].Visible = false;
                GrdDetail.Columns["PRICEPERCARAT"].Visible = false;
                GrdDetail.Columns["DISCOUNT"].Visible = false;
                GrdDetail.Columns["GRDCARAT"].Visible = false;
                GrdDetail.Columns["GRDSHAPENAME"].Visible = false;
                GrdDetail.Columns["GRDCOLORNAME"].Visible = false;
                GrdDetail.Columns["GRDCLARITYNAME"].Visible = false;
                GrdDetail.Columns["GRDCUTNAME"].Visible = false;
                GrdDetail.Columns["GRDPOLNAME"].Visible = false;
                GrdDetail.Columns["GRDSYMNAME"].Visible = false;
                GrdDetail.Columns["GRDFLNAME"].Visible = false;
                GrdDetail.Columns["GRDRAPAPORT"].Visible = false;
                GrdDetail.Columns["GRDDISCOUNT"].Visible = false;
                GrdDetail.Columns["GRDPRICEPERCARAT"].Visible = false;
                GrdDetail.Columns["GRDRAPDATE"].Visible = false;
                GrdDetail.Columns["ORGRAPAPORT"].Visible = false;
                GrdDetail.Columns["ORGDISCOUNT"].Visible = false;
                GrdDetail.Columns["ORGPRICEPERCARAT"].Visible = false;
                GrdDetail.Columns["LABOURRATE"].Visible = false;
                GrdDetail.Columns["BONUSPER"].Visible = false;
                GrdDetail.Columns["BONUSLABOURRATE"].Visible = false;
            }
        }
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                DSDetail = Obj.GetSalaryViewSummaryDetailForWorker(mStrKapanName, mIntFromPacketNo, mIntToPacketNo, 531, mIntEmployee_ID, Val.SqlDate(mStrFromDate), Val.SqlDate(mStrToDate));

                if (DSDetail.Tables.Count > 0)
                {
                    DTabSummary = DSDetail.Tables[0];
                    DTabDetail = DSDetail.Tables[1];
                    //DTabPlanVariationDetail = DS.Tables[3];
                    //DTabDFPlusMinus = DS.Tables[4];
                }
            }
        ...
        private void backgroundWorker1_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                ...
                DTabSummary.DefaultView.Sort = "WORKERCODE";
                DTabSummary = DTabSummary.DefaultView.ToTable();
                DTabDetail.DefaultView.Sort = "WORKERCODE";
        ...
        private void repChkISProcessPktWithFinalMkblClarity_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                int IntRes = Obj.SaveWagesParameterData("FMKBLCLARITY", Val.ToString(Dr["KAPANNAME"]), Val.ToInt32(Dr["PACKETNO"]), Val.ToString(Dr["TAG"]), Val.ToInt64(Dr["WORKER_ID"]), Val.ToBoolean(Dr["ISCONSIDERPLUSDOLLARVARIATION"]), Val.ToBoolean(Dr["ISPROCESSPKTWITHFMKBLCLARITY"]), Val.ToBoolean(Dr["ISCONSIDERSURATEXPAMTCALC"]), false, "MFG");
        ...
        private void repISConsiderSuratExpRMAmtCalc_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                if (GrdDetail.FocusedRowHandle < 0)
                ...
                int IntRes = Obj.SaveWagesParameterData("CONSDSURATEXPAMTCALC", Val.ToString(Dr["KAPANNAME"]), Val.ToInt32(Dr["PACKETNO"]), Val.ToString(Dr["TAG"]), Val.ToInt64(Dr["WORKER_ID"]), Val.ToBoolean(Dr["ISCONSIDERPLUSDOLLARVARIATION"]), Val.ToBoolean(Dr["ISPROCESSPKTWITHFMKBLCLARITY"]), Val.ToBoolean(Dr["ISCONSIDERSURATEXPAMTCALC"]), false, "MFG");
        ...
        private void repBtnDataProcess_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                IntRes = Obj.ResetMarkerWorkerPacketDataForProcess(StrKapan, IntPacketNo, IntPacketNo,StrTag, Val.SqlDate(DTPFromDate.Value.ToShortDateString()), Val.SqlDate(DTPToDate.Value.ToShortDateString()), "WORKER"); //PolishOk Process
                IntRes = Obj.UpdateWorkerDataProcessWithOnlyPktDetail(StrKapan, IntPacketNo, IntPacketNo, StrTag);
        ...
        private void repBtnProcessPrdDetail_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                FrmPrdViewForProcessPktDetailSimple.ShowForm(StrKapan, IntPacketNo, StrTag, "MFG");
                this.Cursor = Cursors.Default;
            }
            catch (Exception ex)
            {
        ...
        private void GrdManagerSum_CustomColumnDisplayText(object sender, DevExpress.XtraGrid.Views.Base.CustomColumnDisplayTextEventArgs e)
        {
            if (e.DisplayText == "0.00" || e.DisplayText == "0" || e.DisplayText == "0.000")
            {
                e.DisplayText = String.Empty;
        ...
        private void repISNotConsiderDollarMinusVariation_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                if (GrdDetail.FocusedRowHandle < 0)
                ...
                DataRow DRow = GrdDetail.GetFocusedDataRow();

                this.Cursor = Cursors.WaitCursor;

                bool IntISNotConsiderDollarMinus = false;

                if (Val.ToBoolean(DRow["ISNOTCONSIDERDOLLARMINUSVARIATION"]) == false)
                    IntISNotConsiderDollarMinus = false; //GrdDetail.SetRowCellValue(GrdDetail.FocusedRowHandle, "ISNODOLLARMINUSDOLLAR", 1);
                else
                    IntISNotConsiderDollarMinus = true; // GrdDetail.SetRowCellValue(GrdDetail.FocusedRowHandle, "ISNODOLLARMINUSDOLLAR", 0);


                int IntRes = Obj.SaveWagesParameterData("NOTCONSIDERDOLLARMINUSVARIATION", 
                                                         Val.ToString(Dr["KAPANNAME"]), 
                                                         Val.ToInt32(Dr["PACKETNO"]), 
                                                         Val.ToString(Dr["TAG"]), 
                                                         Val.ToInt64(Dr["WORKER_ID"]), 
                                                         Val.ToBoolean(Dr["ISCONSIDERPLUSDOLLARVARIATION"]), 
                                                         Val.ToBoolean(Dr["ISPROCESSPKTWITHFMKBLCLARITY"]), 
                                                         Val.ToBoolean(Dr["ISCONSIDERSURATEXPAMTCALC"]),
                                                         IntISNotConsiderDollarMinus, 
                                                         "MFG");
        ...
        private void repBtnRapCalc_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                FrmFindRap.MdiParent = Global.gMainRef; 
                FrmFindRap.ShowFormWithExistData(
                    Val.ToInt(Dr["PRDTYPE_ID"]),
                    Val.ToString(Dr["PRDTYPENAME"]),
                    Val.ToString(Dr["KAPANNAME"]),
                    Val.ToInt(Dr["PACKETNO"]),
                    Val.ToString(Dr["TAG"]),
                    Val.ToInt64(Dr["PACKET_ID"]),
                    Val.ToInt64(Dr["WORKER_ID"]),
                    Val.ToString(Dr["WORKERCODE"])
                    );
        ...
        private void GrdDetail_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            ...
            { 
                case "ARTRAPCALC" :
                    ...
                    this.Cursor = Cursors.WaitCursor;
                    FrmFindRap FrmFindRapArt = new FrmFindRap();
                    FrmFindRapArt.MdiParent = Global.gMainRef;
                    FrmFindRapArt.ShowFormWithExistData(
                        Val.ToInt(Dr["PRDTYPE_ID"]),
                        Val.ToString(Dr["PRDTYPENAME"]),
                        Val.ToString(Dr["KAPANNAME"]),
                        Val.ToInt(Dr["PACKETNO"]),
                ...
                case "POLCHKRAPCALC":
                    ...
                    this.Cursor = Cursors.WaitCursor;
                    FrmFindRap FrmFindRapPolChk = new FrmFindRap();
                    FrmFindRapPolChk.MdiParent = Global.gMainRef;
                    FrmFindRapPolChk.ShowFormWithExistData(
                        Val.ToInt(Dr["ORGPRDTYPE_ID"]),
                        Val.ToString(Dr["ORGPRDTYPE"]),
                        Val.ToString(Dr["KAPANNAME"]),
                        Val.ToInt(Dr["PACKETNO"]),
                        Val.ToString(Dr["TAG"]),
                        Val.ToInt64(Dr["PACKET_ID"]),
                        Val.ToInt64(Dr["ORGEMPLOYEE_ID"]),
                        Val.ToString(Dr["ORGEMPLOYEECODE"])
                        );
        ...
        private void BtnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                string Kapanname = Val.ToString(CmbKapan.Text);
                Int32 FromPktNo = Val.ToInt32(txtFromPacketNo.Text);
                Int32 ToPktNo = Val.ToInt32(txtToPacketNo.Text);
                string Tag = Val.ToString(TxtTag.Text);

                int IntRes = Obj.JobUpdate(Val.SqlDate(DTPFromDate.Value.ToShortDateString()), Val.SqlDate(DTPToDate.Value.ToShortDateString()),Kapanname,FromPktNo,ToPktNo,Tag);

                if (IntRes != 0)
                {
                    Global.Message("Rate Update Sucessfully");
                }
            }
            catch (Exception ex)
            {
        ...
        private void BtnResetFlag_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Global.Message("Please Select Atleast One Kapan For Reset Flag");
                    return;
                }
                TrnPenaltyIncentiveProperty Property = new TrnPenaltyIncentiveProperty();
                ...
                Property.StrFlagResetXml = StrXMLValues;
                Property = Obj.WorkerWagesFlagUpdate(Property);
