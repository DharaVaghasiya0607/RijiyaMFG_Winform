    ...
    public partial class FrmMarkerRollingReport : Form
    {
        ...
        private void BtnRefresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DtabRolling = Obj.GetMarkerRollingReportNew(Val.ToInt64(txtEmployee.Tag), "SUMMARY","", Val.Trim(CmbKapan.Properties.GetCheckedItems()), Val.ToInt(txtFromPacketNo.Text), Val.ToInt(txtToPacketNo.Text), txtTag.Text);
