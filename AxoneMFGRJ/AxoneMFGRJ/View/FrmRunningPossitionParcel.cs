...
{
    public partial class FrmRunningPossitionParcel : Form
    {
        AxonDataLib.BOFormEvents ObjFormEvent = new AxonDataLib.BOFormEvents();
        AxonDataLib.BOConversion Val = new AxonDataLib.BOConversion();
        BOTRN_SinglePacketCreate ObjPacket = new BOTRN_SinglePacketCreate();

        BOTRN_RunningPositionParcel Obj = new BOTRN_RunningPositionParcel();
        ...
        public FrmRunningPossitionParcel()
        {
            InitializeComponent();
        }
        ...
        private void BtnRefresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                mIntPacketNo = Val.ToInt32(txtPacketNo.Text);
        ...
        private void GrdDetDept_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            try
            {
                ...
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "TOTALPCS" || e.Column.FieldName.ToUpper() == "TOTALCARAT" ))
                {
        ...
        private void GrdDetEmpSummary_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            try
            {
                ...
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "TOTALPCS" || e.Column.FieldName.ToUpper() == "TOTALCARAT"|| e.Column.FieldName.ToUpper() == "AGE"))
                {
        ...
        private void BtnWIPPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.Cursor = Cursors.WaitCursor;
                DataTable DTabParcel = Obj.RunningPosstionDataWIPPivotReportParcel(mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo);


                Report.FrmReportViewer FrmReportViewer = new Report.FrmReportViewer();
                FrmReportViewer.MdiParent = Global.gMainRef;
                FrmReportViewer.ShowForm("RunningPossitionProcessPivotWIP", DTabParcel);
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                DataSet DS = Obj.RunningPosstionDataParcel(mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID,Val.ToString(mStrSubGroup));
