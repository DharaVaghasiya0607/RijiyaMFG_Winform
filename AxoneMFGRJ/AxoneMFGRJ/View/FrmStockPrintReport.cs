...
namespace AxoneMFGRJ.View
{
    public partial class FrmStockPrintReport : Form
    {
        ...
        private void GrdDet_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                if (e.Clicks == 2)
                {
                    ...
                    DataTable DtabStockPrintDetail = Obj.GetStockPrintReport("DETAIL", StrKapanName, mStrTable, StrMarker_ID, StrProcessName, StrMainManager_ID, mStrOpeViewType, mStrPacketCategory, mStrPacketGroup);
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                DtabStockPrint = Obj.GetStockPrintReport(mStrOpe, mStrKapan, mStrTable, mStrMarker_ID, "", mStrMainManager_ID, mStrOpeViewType, mStrPacketCategory, mStrPacketGroup);
            }
            catch (Exception ex)
            {
                Global.Message(ex.Message.ToString());
