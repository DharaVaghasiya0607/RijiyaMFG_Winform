...
{
    public partial class FrmOtherProcessProduction : Form
    {
        ...
        public FORMTYPE mFormType = FORMTYPE.BLOCKING;
        ...
        public FrmOtherProcessProduction()
        {
            InitializeComponent();
        }
        ...
        public void ShowForm(FORMTYPE pFormType)
        {
            ...
            if (mFormType == FORMTYPE.BLOCKING)
            {
                ...
                lblTitle.Text = "Blocking Ok Report";
                this.Text = "BLOCKING PRODUCTION";

                GrdDetDetail.Columns["FROMPROCESSNAME"].Visible = true;
            ...
            else if (mFormType == FORMTYPE.CONIC)
            {
                PanelHeader.BackColor = Color.FromArgb(255, 192, 192);   
                lblTitle.Text = "Conic Ok Report";
                this.Text = "CONIC PRODUCTION";
            ...
            else if (mFormType == FORMTYPE.SAWING)
            {
                PanelHeader.BackColor = Color.PowderBlue;
                lblTitle.Text = "Sawing Ok Report";
                this.Text = "SAWING PRODUCTION";

                // 30-04-2019
                GrdDetDetail.Columns["FROMPROCESSNAME"].Visible = true;
                GrdDetDetail.Columns["SECONDPCS"].Visible = true;
                GrdDetDetail.Columns["SECONDCARAT"].Visible = true;
                GrdDetDetail.Columns["EXTRAPCS"].Visible = true;
                GrdDetDetail.Columns["EXTRACARAT"].Visible = true;
                GrdDet.Bands["BANDSECOND"].Visible = true;
                GrdDet.Bands["BANDEXTRA"].Visible = true;
            }
            else if (mFormType == FORMTYPE.MAXI)
            {
                PanelHeader.BackColor = Color.FromArgb(255, 192, 255);
                lblTitle.Text = "Maxi Ok Report";
                this.Text = "MAXI PRODUCTION";
            ...
            else if (mFormType == FORMTYPE.DHAR)
            {
                ...
                lblTitle.Text = "Dhar Ok Report";
                this.Text = "DHAR PRODUCTION";
        ...
        private void BtnRefresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet DS = Obj.GetOtherProcessProductionReport(mFormType.ToString(), Val.Trim(CmbKapan.Properties.GetCheckedItems()), Val.ToInt64(txtEmployee.Tag), Val.SqlDate(DTPFromDate.Value.ToShortDateString()), Val.SqlDate(DTPToDate.Value.ToShortDateString()));
