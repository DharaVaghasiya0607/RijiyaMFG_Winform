...
{
    public partial class FrmMarkerLabourPlusMinusReport : Form
    {
        ...
        public FrmMarkerLabourPlusMinusReport()
        {
            InitializeComponent();
        }
        ...
        public void ShowForm()
        {
            ...
            RdbWagesUpdateForType.SelectedIndex = 0;
        }
        ...
        private void BtnRefresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet DS = Obj.GetMarkerDollarPlusMinusProductionLabour(StrOpe, Val.Trim(CmbKapan.Properties.GetCheckedItems()), Val.ToInt(txtProcess.Tag), Val.ToInt64(txtEmployee.Tag), Val.SqlDate(DTPFromDate.Value.ToShortDateString()), Val.SqlDate(DTPToDate.Value.ToShortDateString()), Val.ToInt32(txtFromPacketNo.Text), Val.ToInt32(txtToPacketNo.Text));
        ...
        private void BtnLiveUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (RdbWagesUpdateForType.SelectedIndex == 1) //For Worker
                {
                    if (ChkISWithReset.Checked)
                    {
                        int IntRes1 = Obj.ResetMarkerWorkerPacketDataForProcess(Val.Trim(CmbKapan.Properties.GetCheckedItems()),Val.ToInt32(txtFromPacketNo.Text), Val.ToInt32(txtToPacketNo.Text),"", Val.SqlDate(DTPFromDate.Value.ToShortDateString()), Val.SqlDate(DTPToDate.Value.ToShortDateString()),"WORKER"); //PolishOk Process
                    }
                    IntRes = Obj.UpdateWorkerLabourLiveGradingColorStatus(Val.Trim(CmbKapan.Properties.GetCheckedItems()), Val.SqlDate(DTPFromDate.Value.ToShortDateString()), Val.SqlDate(DTPToDate.Value.ToShortDateString()), Val.ToInt32(txtFromPacketNo.Text), Val.ToInt32(txtToPacketNo.Text),531); //PolishOk Process
                }
                else  if (RdbWagesUpdateForType.SelectedIndex == 0) // For Marker
                {
                    if (ChkISWithReset.Checked)
                    {
                        int IntRes1 = Obj.ResetMarkerWorkerPacketDataForProcess(Val.Trim(CmbKapan.Properties.GetCheckedItems()), Val.ToInt32(txtFromPacketNo.Text), Val.ToInt32(txtToPacketNo.Text),"", Val.SqlDate(DTPFromDate.Value.ToShortDateString()), Val.SqlDate(DTPToDate.Value.ToShortDateString()), "MARKER"); //PolishOk Process
                    }
                    IntRes = Obj.UpdateMarkerLabourLiveGradingColorStatus(Val.Trim(CmbKapan.Properties.GetCheckedItems()), Val.SqlDate(DTPFromDate.Value.ToShortDateString()), Val.SqlDate(DTPToDate.Value.ToShortDateString()), Val.ToInt32(txtFromPacketNo.Text), Val.ToInt32(txtToPacketNo.Text));
                }
                else if (RdbWagesUpdateForType.SelectedIndex == 2) // For BlockingChecker
                {
                    if (ChkISWithReset.Checked)
                    {
                        int IntRes1 = Obj.ResetMarkerWorkerPacketDataForProcess(Val.Trim(CmbKapan.Properties.GetCheckedItems()), Val.ToInt32(txtFromPacketNo.Text), Val.ToInt32(txtToPacketNo.Text),"", Val.SqlDate(DTPFromDate.Value.ToShortDateString()), Val.SqlDate(DTPToDate.Value.ToShortDateString()), "BLOCKING"); //PolishOk Process
                    }
                    IntRes = Obj.UpdateBlockingChkrLabourLiveGradingColorStatus(Val.Trim(CmbKapan.Properties.GetCheckedItems()), Val.SqlDate(DTPFromDate.Value.ToShortDateString()), Val.SqlDate(DTPToDate.Value.ToShortDateString()), Val.ToInt32(txtFromPacketNo.Text), Val.ToInt32(txtToPacketNo.Text),"");
                }
