...
{
    public partial class FrmLabourPriceHeadDetailNew : DevExpress.XtraEditors.XtraForm
    {
        ...
        public FrmLabourPriceHeadDetailNew()
        {
            InitializeComponent();
        }
        ...
        {
            Global.ExcelExport("WorkLabour_" + txtShape.Text + "" + txtYear.Text + "_" + Global.GetMonthName(Val.ToInt(txtMonth.Text)) + "", PivotGrdDet);
        }
        ...
        private void BtnRefresh_Click(object sender, EventArgs e)
        {
            ...
            DtabPrice = ObjPriceDet.GetData(Val.ToInt(txtShape.Tag), Val.ToInt(txtYear.Text), Val.ToInt(txtMonth.Text));
        ...
        {
            FrmLabourQuickUpload FrmLabourQuickUpload = new FrmLabourQuickUpload();
            FrmLabourQuickUpload.ShowForm();
        }
        ...
        private void BtnCopy_Click(object sender, EventArgs e)
        {
            ...
            int IntRes = ObjPriceDet.CopyPaste(Val.ToInt(txtYear.Text), Val.ToInt(txtMonth.Text), Val.ToInt(txtCopyToYear.Text), Val.ToInt(txtCopyToMonth.Text));
            this.Cursor = Cursors.Default; 
