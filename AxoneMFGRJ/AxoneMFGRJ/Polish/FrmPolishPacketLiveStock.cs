...
namespace AxoneMFGRJ.Polish
{
    public partial class FrmPolishPacketLiveStock : DevExpress.XtraEditors.XtraForm
    {
        ...
        public void ShowForm()
        {
            ...
            DTabSubPacketLiveStock = ObjPolish.GetDataForPolishPacketLiveStock("", TxtManager.Text, TxtKapan.Text, "FULLSTOCK", 0);
        ...
        private void BtnMainPacketSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DTabMainPacketLiveStock = ObjPolish.GetDataForPolishPacketLiveStock("MAINPACKET", StrManager, TxtKapan.Text, pStrDisplayType, pStrEmp_Id);
        ...
        private void repBtnProcessIssue_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (StrPolishPacketID != 0)
                {
                    ...
                    FrmPolishIssueWithPackets.ShowForm(StrKapanName, StrKapan_ID, StrManager, StrManager_ID, StrPolishPacketID);
        ...
        private void BtnSubPacketSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DTabSubPacketLiveStock = ObjPolish.GetDataForPolishPacketLiveStock("", StrManager, txtSubPktKapanName.Text, pStrDisplayType, pIntEMP_ID);
                MainGridSubPkt.DataSource = DTabSubPacketLiveStock;
                GrdDetSubPkt.BestFitColumns();
                MainGridSubPkt.Refresh();
        ...
        private void BtnTransfer_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //DTabTransfer = Global.GetSelectedRecordOfGrid(GrdDetMainPkt, true, ObjGridSelectionForKapan);
