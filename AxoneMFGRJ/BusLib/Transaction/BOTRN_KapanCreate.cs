...
namespace BusLib.Transaction
{
    public class BOTRN_KapanCreate
    {
        ...
        public DataTable GetDataForSinglePacketLiveStockJangednoWiseInfo(string StrOpe, string pStrDisplay, string pStrKapanName, int pIntPacketNo, string pStrTag, string pStrBarcode, int pStrPktSerialNo, string pStrJangedNo) //#P : 11-06-2022 : Used ForJangedNo
        {
            Ope.ClearParams();
        ...
        public DataTable GetPacketDataForBarcodePrint(string KapanName, string SubLot, string SubLot1, Int32 pIntFromPacketNo, Int32 pIntToPacketNo, string pStrTag)
        {
            Ope.ClearParams();
            DataTable DTab = new DataTable();
