...
namespace AxoneMFGRJ.Parcel
{
    public partial class FrmSizeAssortment : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void BtnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable DTabSummury = ObjKapan.SizeAssortmentGetKapanData(txtSearchInwardNo.Text,
                                ...
                                Val.Trim(CmbYear.Properties.GetCheckedItems()));
        ...
        public void LoadData()
        {
            ...
            {
                DTabDetail = ObjKapan.SizeAssortmentGetSizeData(pStrKapanName, Val.ToInt(txtShape.Tag), IsAdditionalAssortment, Val.ToString(CmbPriceType.SelectedItem));
            }
