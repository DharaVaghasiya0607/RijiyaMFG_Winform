...
{
    public partial class FrmGradingComparisionView : Form
    {
        ...
        public FrmGradingComparisionView()
        {
            InitializeComponent();
        }
        ...
        {
            string Str = txtEmployee.Text.Trim().Length == 0 ? "All Worker" : txtEmployee.Text;
            mStrReportTitle = "Grading Comparision Detail (" + Str + ")";
            try
            {
                SaveFileDialog svDialog = new SaveFileDialog();
                svDialog.DefaultExt = ".xlsx";
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                DS = Obj.GetGradingComparisionView(mStrFromDate, mStrToDate, Val.ToInt64(txtEmployee.Tag), "DETAIL", "", "", "", "", "", 0, 0);
        ...
        private void GrdTotal_RowClick(object sender, RowClickEventArgs e)
        {
            try
            {
                ...
                DS = new BOTRN_RunninPossition().GetGradingComparisionView(mStrFromDate, mStrToDate, Val.ToInt64(txtEmployee.Tag), "SUMMURY", mStrTotalClickType, StrExp, StrGrd, "", "", mStrMonth, mStrYear);
        ...
        {
            string Str = txtEmployee.Text.Trim().Length == 0 ? "All Worker" : txtEmployee.Text;
            mStrReportTitle = "Grading Comparision Summury (" + Str + ")";
            try
            {
                SaveFileDialog svDialog = new SaveFileDialog();
                svDialog.DefaultExt = ".xlsx";
        ...
        private void GrdDetail_RowCellStyle(object sender, RowCellStyleEventArgs e)
        {
            try
            {
                ...
                //else if (StrClick == "TOTAL" && Val.ToString(e.Column.FieldName) == "LYYMMM")
                //{
                //    e.Appearance.Font = new Font("Verdana", 8, FontStyle.Bold);
                //    e.Appearance.BackColor = Color.FromArgb(255, 255, 192);
                //}
