...
namespace AxoneMFGRJ.View
{
    public partial class FrmPlaningReportAssorterWise : Form
    {
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                DS = Obj.PlanningReportAssorterWiseGetData(mStrKapan, mStrTable, StrFromDate, StrToDate, StrPrdType_ID,mStrMainManage_ID, mStrOpeViewType,mStrAssorter_ID, mStrPacketCategory, mStrPacketGroup, mStrOpe, pStrDiamondType);
