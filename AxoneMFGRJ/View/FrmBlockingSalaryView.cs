...
{
    public partial class FrmBlockingSalaryView : Form
    {
        ...
        private void BtnRefresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //DataSet DS = Obj.GetOtherProcessProductionReport("",Val.Trim(CmbKapan.Properties.GetCheckedItems()), Val.ToInt64(txtEmployee.Tag), Val.SqlDate(DTPFromDate.Value.ToShortDateString()), Val.SqlDate(DTPToDate.Value.ToShortDateString()));
                DataSet DS = Obj.GetBlockingSalaryViewSummaryDetail(Val.Trim(CmbKapan.Properties.GetCheckedItems()), 0, 0, Val.ToInt64(txtEmployee.Tag), Val.SqlDate(DTPFromDate.Value.ToShortDateString()), Val.SqlDate(DTPToDate.Value.ToShortDateString()));
        ...
        public void Link_CreateMarginalHeaderArea(object sender, CreateAreaEventArgs e)
        {
            ...
            StrFilter = StrFilter + ", Process : Blocking, Chapka, 16Pel";
            //// ' For Filter 
        ...
        {
            mStrReportTitle = "Blocking Salary Report(Employee Wise)";
            CommonExcelExportFuction(MainGrid, GrdDet, "BlockingSalaryReport");
        }
