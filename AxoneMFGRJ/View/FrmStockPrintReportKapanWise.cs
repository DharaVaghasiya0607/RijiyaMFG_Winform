...
namespace AxoneMFGRJ.View
{
    public partial class FrmStockPrintReportKapanWise : Form
    {
        ...
        private void GrdDet_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            ...
            try
            {
                ...
                if (e.Clicks == 2)
                {
                    ...
                    DataTable DtabStockPrintDetail = Obj.GetStockPrintKapanWiseReport("DETAIL", mStrKapan, mStrKapanID, mStrTable, "", StrProcessName, StrReportGroup, mStrPacketCategory, mStrPacketGroup);
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                DtabStockPrint = Obj.GetStockPrintKapanWiseReport(mStrOpe, mStrKapan,mStrKapanID, mStrTable, "", "", "", mStrPacketCategory, mStrPacketGroup) ;
            }
            catch (Exception ex)
            {
                Global.Message(ex.Message.ToString());
