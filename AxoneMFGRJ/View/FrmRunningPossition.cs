...
namespace AxoneMFGRJ.View
{
    public partial class FrmRunningPossition : Form
    {
        ...
        DataTable DTabMainManagerStock = new DataTable();
        ...
        */
        ...
        private void GrdDetDept_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            try
            {
                ...
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "ROUGHPCS" || e.Column.FieldName.ToUpper() == "ROUGHCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "DEPARTMENT", Val.ToString(DRow["DEPARTMENTNAME"]), "", "", "","", "ROUGH");
                }
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "MAKPCS" || e.Column.FieldName.ToUpper() == "MAKCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "DEPARTMENT", Val.ToString(DRow["DEPARTMENTNAME"]), "", "", "","", "MAK");
                }
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "POLPCS" || e.Column.FieldName.ToUpper() == "POLCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "DEPARTMENT", Val.ToString(DRow["DEPARTMENTNAME"]), "", "", "","", "POL");
                }
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "REPPCS" || e.Column.FieldName.ToUpper() == "REPCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "DEPARTMENT", Val.ToString(DRow["DEPARTMENTNAME"]), "", "", "","", "REP");
                }
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "PENDINGPCS" || e.Column.FieldName.ToUpper() == "PENDINGCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "DEPARTMENT", Val.ToString(DRow["DEPARTMENTNAME"]), "", "", "","", "PENDING");
                }
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "TOTALPCS" || e.Column.FieldName.ToUpper() == "TOTALCARAT" || e.Column.FieldName.ToUpper() == "AGE"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "DEPARTMENT", Val.ToString(DRow["DEPARTMENTNAME"]), "", "", "","", "TOTAL");
                }
                ...
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "SECONDPCS" || e.Column.FieldName.ToUpper() == "SECONDCARAT"))
                {
                    ...
                    if (UDRow != null)
                    {
                        ...
                        FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "DEPARTMENT", Val.ToString(DRow["DEPARTMENTNAME"]), "", "", "","", "SECOND");
                    }
                }
                ...
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "EXTRAPCS" || e.Column.FieldName.ToUpper() == "EXTRACARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "DEPARTMENT", Val.ToString(DRow["DEPARTMENTNAME"]), "", "", "","", "EXTRA");
                }
                ...
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "LOSSCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "DEPARTMENT", Val.ToString(DRow["DEPARTMENTNAME"]), "", "", "","", "LOSS");
                }
        ...
        private void GrdDetEmpSummary_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            try
            {
                ...
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "ROUGHPCS" || e.Column.FieldName.ToUpper() == "ROUGHCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "EMPLOYEE", "", "", Val.ToString(DRow["EMPLOYEENAME"]), "","", "ROUGH");
                }
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "MAKPCS" || e.Column.FieldName.ToUpper() == "MAKCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "EMPLOYEE", "", "", Val.ToString(DRow["EMPLOYEENAME"]), "","", "MAK");
                ...
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "POLPCS" || e.Column.FieldName.ToUpper() == "POLCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "EMPLOYEE", "", "", Val.ToString(DRow["EMPLOYEENAME"]), "","", "POL");
                ...
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "TOTALPCS" || e.Column.FieldName.ToUpper() == "TOTALCARAT" || e.Column.FieldName.ToUpper() == "AGE"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "EMPLOYEE", "", "", Val.ToString(DRow["EMPLOYEENAME"]), "","", "TOTAL");
                ...
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "SECONDPCS" || e.Column.FieldName.ToUpper() == "SECONDCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "EMPLOYEE", "", "", Val.ToString(DRow["EMPLOYEENAME"]), "","", "SECOND");
                ...
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "EXTRAPCS" || e.Column.FieldName.ToUpper() == "EXTRACARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "EMPLOYEE", "", "", Val.ToString(DRow["EMPLOYEENAME"]), "","", "EXTRA");
                ...
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "LOSSCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "EMPLOYEE", "", "", Val.ToString(DRow["EMPLOYEENAME"]), "","", "LOSS");
        ...
        private void GrdDetManager_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            try
            {
                ...
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "ROUGHPCS" || e.Column.FieldName.ToUpper() == "ROUGHCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), ",MANAGER", Val.ToString(DRow["DEPARTMENTNAME"]), Val.ToString(DRow["MANAGERNAME"]), "", "","", "ROUGH");
                }
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "MAKPCS" || e.Column.FieldName.ToUpper() == "MAKCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), ",MANAGER", Val.ToString(DRow["DEPARTMENTNAME"]), Val.ToString(DRow["MANAGERNAME"]), "", "","", "MAK");
                }
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "POLPCS" || e.Column.FieldName.ToUpper() == "POLCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), ",MANAGER", Val.ToString(DRow["DEPARTMENTNAME"]), Val.ToString(DRow["MANAGERNAME"]), "", "","", "POL");
                }
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "REPPCS" || e.Column.FieldName.ToUpper() == "REPCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle); FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), ",MANAGER", Val.ToString(DRow["DEPARTMENTNAME"]), Val.ToString(DRow["MANAGERNAME"]), "", "","", "REP");
                }
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "PENDINGPCS" || e.Column.FieldName.ToUpper() == "PENDINGCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle); FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), ",MANAGER", Val.ToString(DRow["DEPARTMENTNAME"]), Val.ToString(DRow["MANAGERNAME"]), "", "","", "PENDING");
                ...
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "TOTALPCS" || e.Column.FieldName.ToUpper() == "TOTALCARAT" || e.Column.FieldName.ToUpper() == "AGE"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle); FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), ",MANAGER", Val.ToString(DRow["DEPARTMENTNAME"]), Val.ToString(DRow["MANAGERNAME"]), "", "","", "TOTAL");
                }
                ...
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "SECONDPCS" || e.Column.FieldName.ToUpper() == "SECONDCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle); FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), ",MANAGER", Val.ToString(DRow["DEPARTMENTNAME"]), Val.ToString(DRow["MANAGERNAME"]), "", "","", "SECOND");
                }
                ...
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "EXTRAPCS" || e.Column.FieldName.ToUpper() == "EXTRACARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle); FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), ",MANAGER", Val.ToString(DRow["DEPARTMENTNAME"]), Val.ToString(DRow["MANAGERNAME"]), "", "","", "EXTRA");
                }
                ...
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "LOSSCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle); FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), ",MANAGER", Val.ToString(DRow["DEPARTMENTNAME"]), Val.ToString(DRow["MANAGERNAME"]), "", "","", "LOSS");
        ...
        private void GrdDetProcessWise_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            try
            {
                ...
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "ROUGHPCS" || e.Column.FieldName.ToUpper() == "ROUGHCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "PROCESS", "", "", "", Val.ToString(DRow["PROCESSNAME"]),"", "ROUGH");
                }
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "MAKPCS" || e.Column.FieldName.ToUpper() == "MAKCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "PROCESS", "", "", "", Val.ToString(DRow["PROCESSNAME"]),"", "MAK");
                }
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "POLPCS" || e.Column.FieldName.ToUpper() == "POLCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "PROCESS", "", "", "", Val.ToString(DRow["PROCESSNAME"]),"", "POL");
                }
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "REPPCS" || e.Column.FieldName.ToUpper() == "REPCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "PROCESS", "", "", "", Val.ToString(DRow["PROCESSNAME"]),"", "REP");
                }
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "PENDINGPCS" || e.Column.FieldName.ToUpper() == "PENDINGCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "PROCESS", "", "", "", Val.ToString(DRow["PROCESSNAME"]),"", "PENDING");
                }
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "TOTALPCS" || e.Column.FieldName.ToUpper() == "TOTALCARAT" || e.Column.FieldName.ToUpper() == "AGE"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "PROCESS", "", "", "", Val.ToString(DRow["PROCESSNAME"]),"", "TOTAL");
                }
                ...
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "SECONDPCS" || e.Column.FieldName.ToUpper() == "SECONDCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "PROCESS", "", "", "", Val.ToString(DRow["PROCESSNAME"]),"", "SECOND");
                }
                ...
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "EXTRAPCS" || e.Column.FieldName.ToUpper() == "EXTRACARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "PROCESS", "", "", "", Val.ToString(DRow["PROCESSNAME"]),"", "EXTRA");
                }
                ...
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "LOSSCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), "PROCESS", "", "", "", Val.ToString(DRow["PROCESSNAME"]),"", "LOSS");
                }
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                if (DS != null)
                {
                    ...
                    //DTabStockDetail = DS.Tables[3];
                    //DTabLossDetail = DS.Tables[4];
                    DTabProcessStock = DS.Tables[3];
                    DTabMainManagerStock = DS.Tables[4];
                }
                else
                {
                    Global.Message("No Dataset Found ");
                }
        ...
        private void backgroundWorker1_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                ...
                MainGrdMainManager.DataSource = DTabMainManagerStock;
                MainGrdMainManager.Refresh();

                GrdDetProcessWise.EndUpdate();
                GrdDetDept.EndUpdate();
                GrdDetManager.EndUpdate();
                GrdDetEmpSummary.EndUpdate();
                GrdMainManager.EndUpdate();
        ...
        private void GrdMainManager_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            try
            {
                ...
                DataRow DRow = GrdMainManager.GetDataRow(e.RowHandle);
                ...
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "ROUGHPCS" || e.Column.FieldName.ToUpper() == "ROUGHCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), ",MAINMANAGER", Val.ToString(DRow["DEPARTMENTNAME"]), "", "", "", Val.ToString(DRow["MAINMANAGERNAME"]), "ROUGH");
                }
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "MAKPCS" || e.Column.FieldName.ToUpper() == "MAKCARAT"))
                {
                    string StrReportTitle = "Manager [ " + Val.ToString(DRow["MANAGERNAME"]) + " ] Department [ " + Val.ToString(DRow["DEPARTMENTNAME"]) + " ] Confired Makable Stock Packet Wise";
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), ",MAINMANAGER", Val.ToString(DRow["DEPARTMENTNAME"]), "", "", "", Val.ToString(DRow["MAINMANAGERNAME"]), "MAK");
                }
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "POLPCS" || e.Column.FieldName.ToUpper() == "POLCARAT"))
                {
                    string StrReportTitle = "Manager [ " + Val.ToString(DRow["MANAGERNAME"]) + " ] Department [ " + Val.ToString(DRow["DEPARTMENTNAME"]) + " ] Confired Polish Stock Packet Wise";
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), ",MAINMANAGER", Val.ToString(DRow["DEPARTMENTNAME"]), "", "", "", Val.ToString(DRow["MAINMANAGERNAME"]), "POL");
                }
                if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "REPPCS" || e.Column.FieldName.ToUpper() == "REPCARAT"))
                {
                    ...
                    if (UDRow != null)
                    {
                        ...
                        FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                        FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                        FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), ",MAINMANAGER", Val.ToString(DRow["DEPARTMENTNAME"]),"", "", "", Val.ToString(DRow["MAINMANAGERNAME"]), "REP");
                    }
                }
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "PENDINGPCS" || e.Column.FieldName.ToUpper() == "PENDINGCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), ",MAINMANAGER", Val.ToString(DRow["DEPARTMENTNAME"]), "", "", "", Val.ToString(DRow["MAINMANAGERNAME"]), "PENDING");
                }
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "TOTALPCS" || e.Column.FieldName.ToUpper() == "TOTALCARAT" || e.Column.FieldName.ToUpper() == "AGE"))
                {

                    DataRow[] UDRow = DTabStockDetail.Select("MAINMANAGERNAME = '" + Val.ToString(DRow["MANAGERNAME"]) + "' And MAINDEPARTMENTNAME = '" + Val.ToString(DRow["DEPARTMENTNAME"]) + "'");
                    if (UDRow != null)
                    {
                        string StrReportTitle = "Manager [ " + Val.ToString(DRow["MANAGERNAME"]) + " ] Department [ " + Val.ToString(DRow["DEPARTMENTNAME"]) + " ] Total Stock Packet Wise";
                        FrmRunningPossitionPopupDetail FrmRunningPossitionPopupDetail = new FrmRunningPossitionPopupDetail();
                        FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                        FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                        FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), ",MAINMANAGER", Val.ToString(DRow["DEPARTMENTNAME"]), "", "", "", Val.ToString(DRow["MAINMANAGERNAME"]), "TOTAL");
                    }
                }
                ...
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "SECONDPCS" || e.Column.FieldName.ToUpper() == "SECONDCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), ",MAINMANAGER", Val.ToString(DRow["DEPARTMENTNAME"]), "", "", "", Val.ToString(DRow["MAINMANAGERNAME"]), "SECOND");
                }
                ...
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "EXTRAPCS" || e.Column.FieldName.ToUpper() == "EXTRACARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), ",MAINMANAGER", Val.ToString(DRow["DEPARTMENTNAME"]), "", "", "", Val.ToString(DRow["MAINMANAGERNAME"]), "EXTRA");
                }
                ...
                else if (e.Clicks == 2 && (e.Column.FieldName.ToUpper() == "LOSSCARAT"))
                {
                    ...
                    FrmRunningPossitionPopupDetail.MdiParent = Global.gMainRef;
                    FrmRunningPossitionPopupDetail.mStrOpe = mStrStockCategory;
                    FrmRunningPossitionPopupDetail.ShowForm(StrReportTitle, mFormType.ToString(), mStrStockCategory, mStrStockType, mStrKapan, mIntPacketNo, mStrTag, Val.ToBoolean(ChkWithExtraStock.Checked), Val.ToString(mStrProcess), mMainManager_ID, Val.ToString(mStrSubGroup), ",MAINMANAGER", Val.ToString(DRow["DEPARTMENTNAME"]), "", "", "", Val.ToString(DRow["MAINMANAGERNAME"]), "LOSS");
                }
        ...
        private void MainGrdProcess_Click(object sender, EventArgs e)
        {
