...
{
    public partial class FrmSalaryViewForProcessWise : Form
    {
        ...
        public FrmSalaryViewForProcessWise()
        {
            InitializeComponent();
        }
        ...
        public void ShowForm()
        {
            ...
            ChkCmbProcess.Properties.DataSource = new BusLib.BOComboFill().FillCmb(BusLib.BOComboFill.TABLE.MST_LABOURPROCESS);
            ...
            //ChkCmbManager.Properties.DataSource = new BusLib.BOComboFill().FillCmb(BusLib.BOComboFill.TABLE.MST_EMPLOYEE);
            //ChkCmbManager.Properties.DisplayMember = "EMPLOYEECODE" + "-" + "EMPLOYEENAME";
            //ChkCmbManager.Properties.ValueMember = "EMPLOYEE_ID";
        ...
        {
            mStrReportTitle = "ProcessWise Labour Report(Employee Wise)";
        ...
        {
            mStrReportTitle = "ProcessWise Labour Report Detail (" + GrpDetail.Text + ")";
            try
            {
                SaveFileDialog svDialog = new SaveFileDialog();
                svDialog.DefaultExt = ".xlsx";
